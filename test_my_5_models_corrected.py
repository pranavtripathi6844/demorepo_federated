    ...
    my_models = [
        {
            'nc': 1,
            'j': 4,
            'checkpoint': 'federated_nc1_j4_final.pth',  # CORRECTED
            'description': 'Non-IID: 1 class per client'
        },
        {
            'nc': 5,
            'j': 4,
            'checkpoint': 'federated_nc5_j4_final.pth',  # CORRECTED
            'description': 'Non-IID: 5 classes per client'
        },
        {
            'nc': 10,
            'j': 4,
            'checkpoint': 'federated_nc10_j4_final.pth',  # CORRECTED
            'description': 'Non-IID: 10 classes per client'
        },
        {
            'nc': 50,
            'j': 4,
            'checkpoint': 'federated_nc50_j4_final.pth',  # CORRECTED
            'description': 'Non-IID: 50 classes per client'
        },
        {
            'nc': 100,
            'j': 4,
            'checkpoint': 'federated_nc100_j4_final.pth',  # CORRECTED
