...
def load_model_from_checkpoint(checkpoint_path: str, num_classes: int = 100, freeze_backbone: bool = True):
    """Load DINOBackboneClassifier from checkpoint."""
    try:
        # Create model - using DINOBackboneClassifier like in federated training
...
def main():
    ...
    # Define your 5 specific models - CORRECTED CHECKPOINT NAMES
    my_models = [
        {
            'nc': 1,
            'j': 4,
            'checkpoint': 'federated_nc1_j4_final.pth',
            'description': 'Non-IID: 1 class per client'
        },
        {
            'nc': 5,
            'j': 4,
            'checkpoint': 'federated_nc5_j4_final.pth',
            'description': 'Non-IID: 5 classes per client'
        },
        {
            'nc': 10,
            'j': 4,
            'checkpoint': 'federated_nc10_j4_final.pth',
            'description': 'Non-IID: 10 classes per client'
        },
        {
            'nc': 50,
            'j': 4,
            'checkpoint': 'federated_nc50_j4_final.pth',
            'description': 'Non-IID: 50 classes per client'
        },
        {
            'nc': 100,
            'j': 4,
            'checkpoint': 'federated_nc100_j4_final.pth',
